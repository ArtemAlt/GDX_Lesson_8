...
public class DungeonGame extends Game {
    ...
    // 2. На деревьях растут ягоды (не на всех), их можно собирать. Каждый 5 ход,                  - на всех
    // на случайном дереве растет ягода
    // 3. При выполнении действий сытость персонажа падает, если сытости падать некуда,            -  done
    // то начинает падать здоровье
    // 4. Если кликнуть на дерево, то персонаж съедает все ягоды с него и заполняет сытость        - none
    // 5. * Когда здоровье падает дод 0, нужно перекинуть игрока на экран Game Over                 -done
